...
class NeuralRadianceField(torch.nn.Module):
    ...
    def __init__(
        ...
        # TODO: Add ReLU
        # TODO: Add batch norm after Linear and before ReLU

        self.density_hidden_layer = nn.Sequential(
    ...
    def forward(self, ray_bundle):
        ...
        # Calculate densities
        density = self.density_hidden_layer(features)
...
class NeuralSurface(torch.nn.Module):
    def __init__(
        ...
        embedding_dim_distance = self.harmonic_embedding_xyz.output_dim

        self.mlp_xyz = MLPWithInputSkips(
            cfg.n_layers_distance,
            embedding_dim_distance,
            cfg.n_hidden_neurons_distance,
            embedding_dim_distance,
            cfg.n_hidden_neurons_distance,
